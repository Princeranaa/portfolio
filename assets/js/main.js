...
// function circleMouseFollowers(xscale,yscale){
//     window.addEventListener("mousemove",function(detail){
//         document.querySelector("#mini-circle").style.transform = `translate(${detail.clientX}px, ${detail.clientY}px)`;
//     })
// }

// circleMouseFollowers();
